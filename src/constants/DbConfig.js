...
export const PG_USER = process.env.PG_USER ? process.env.PG_USER : 'postgres';
export const PG_HOST = process.env.PG_HOST ? process.env.PG_HOST : 'localhost';
export const PG_DATABASE = process.env.PG_DATABASE ? process.env.PG_DATABASE : 'haraapidev';
export const PG_PASSWORD = process.env.PG_PASSWORD ? process.env.PG_PASSWORD : 'swordfish';
export const PG_PORT = process.env.PG_PORT ? process.env.PG_PORT : 5432;